...
test('Scenario 1 - warehouse split across Main + East for an oversubscribed SKU', async () => {
...
test('Scenario 3 - shipment-aware invoicing bills only the shipped quantity', async () => {
...
test('Scenario 2 - subscription proration: dry-run matches applied change; downgrade credits instead of charges', async () => {
...
test('Audit trail - every mutating fulfillment action is attributable to the real actor', async () => {
