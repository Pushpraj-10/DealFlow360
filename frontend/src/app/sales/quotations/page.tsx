...
export default function QuotationsPage() {
  ...
  const loadLines = (id: string) => {
    api.get<{ lines: QuotationLine[] }>(`/quotations/${id}/risk`).catch(() => null);
  };
  ...
  const selectedQuotation = quotations.find((q) => q._id === selectedId);
          ...
          {quotations.map((q) => (
            <button
              ...
              style={{
                ...
                padding: '12px 16px',
                borderBottom: '1px solid var(--border)',
                background: selectedId === q._id ? 'var(--accent-light)' : 'transparent',
                border: 'none',
                cursor: 'pointer',
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <span
                  style={{
                    fontSize: 13,
                    fontWeight: 600,
                    color: selectedId === q._id ? 'var(--accent)' : 'var(--text-primary)',
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: 'var(--text-secondary)', marginTop: 3 }}>
                    {typeof selectedQuotation.customerId === 'object'
                      ? selectedQuotation.customerId.name
                      : 'Customer'}
                  </div>
                </div>
